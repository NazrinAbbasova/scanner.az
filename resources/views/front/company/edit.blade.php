            ...
            <div class="col-lg-9">
                <div class="profile-content">
                    <div class="content-title">
                        <h5 class="font-weight-700 pull-left">Haqqımızda</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label for="company-name">İşə götürən adı*</label>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="field" type="text" value="{{ auth()->user()->field }}" placeholder="Fəaliyyət göstərdiyiniz sahə">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label for="email">E-mail*</label>
                                    <input readonly value="{{ auth()->user()->email }}" type="email" placeholder="E-mail adresiniz" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label for="company-name">İşə götürən haqqında</label>
                                    <textarea name="description" placeholder="Haqqınızda" required rows="5">{{ auth()->user()->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="success_email" value="{{ auth()->user()->success_email }}" placeholder="Şablon mesajınız" type="text">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label for="info-message">Uyğun olmayan namizədlərə göndəriləcək imtina mesajı</label>
                                    <input name="fail_email" value="{{ auth()->user()->fail_email }}" placeholder="Şablon mesajınız" type="text">
                                </div>
                            </div>
